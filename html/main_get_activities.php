...
if($bucket == "0" && $kind == "0"){
    $sql = "SELECT * FROM activity ORDER BY time DESC";
}
else if($bucket == "0"){
    $sql = "SELECT * FROM activity WHERE kind='" . $kind . "' ORDER BY time DESC";
}
else if($kind == "0"){
    $sql = "SELECT * FROM activity WHERE bucket='" . $bucket . "' ORDER BY time DESC";
}
else{
    $sql = "SELECT * FROM activity WHERE kind='" . $kind . "' AND bucket='" . $bucket . "' ORDER BY time DESC";
}
